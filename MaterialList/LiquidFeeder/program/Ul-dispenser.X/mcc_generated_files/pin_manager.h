...
// get/set DOSE aliases
#define DOSE_TRIS               TRISBbits.TRISB0
#define DOSE_LAT                LATBbits.LATB0
#define DOSE_PORT               PORTBbits.RB0
#define DOSE_WPU                WPUBbits.WPUB0
#define DOSE_ANS                ANSELHbits.ANS12
#define DOSE_SetHigh()            do { LATBbits.LATB0 = 1; } while(0)
#define DOSE_SetLow()             do { LATBbits.LATB0 = 0; } while(0)
#define DOSE_Toggle()             do { LATBbits.LATB0 = ~LATBbits.LATB0; } while(0)
#define DOSE_GetValue()           PORTBbits.RB0
#define DOSE_SetDigitalInput()    do { TRISBbits.TRISB0 = 1; } while(0)
#define DOSE_SetDigitalOutput()   do { TRISBbits.TRISB0 = 0; } while(0)
#define DOSE_SetPullup()      do { WPUBbits.WPUB0 = 1; } while(0)
#define DOSE_ResetPullup()    do { WPUBbits.WPUB0 = 0; } while(0)
#define DOSE_SetAnalogMode()  do { ANSELHbits.ANS12 = 1; } while(0)
#define DOSE_SetDigitalMode() do { ANSELHbits.ANS12 = 0; } while(0)
...
// get/set SPARE_IN2 aliases
#define SPARE_IN2_TRIS               TRISCbits.TRISC3
#define SPARE_IN2_LAT                LATCbits.LATC3
#define SPARE_IN2_PORT               PORTCbits.RC3
#define SPARE_IN2_SetHigh()            do { LATCbits.LATC3 = 1; } while(0)
#define SPARE_IN2_SetLow()             do { LATCbits.LATC3 = 0; } while(0)
#define SPARE_IN2_Toggle()             do { LATCbits.LATC3 = ~LATCbits.LATC3; } while(0)
#define SPARE_IN2_GetValue()           PORTCbits.RC3
#define SPARE_IN2_SetDigitalInput()    do { TRISCbits.TRISC3 = 1; } while(0)
#define SPARE_IN2_SetDigitalOutput()   do { TRISCbits.TRISC3 = 0; } while(0)

// get/set SPARE_OUT1 aliases
#define SPARE_OUT1_TRIS               TRISCbits.TRISC4
#define SPARE_OUT1_LAT                LATCbits.LATC4
#define SPARE_OUT1_PORT               PORTCbits.RC4
#define SPARE_OUT1_SetHigh()            do { LATCbits.LATC4 = 1; } while(0)
#define SPARE_OUT1_SetLow()             do { LATCbits.LATC4 = 0; } while(0)
#define SPARE_OUT1_Toggle()             do { LATCbits.LATC4 = ~LATCbits.LATC4; } while(0)
#define SPARE_OUT1_GetValue()           PORTCbits.RC4
#define SPARE_OUT1_SetDigitalInput()    do { TRISCbits.TRISC4 = 1; } while(0)
#define SPARE_OUT1_SetDigitalOutput()   do { TRISCbits.TRISC4 = 0; } while(0)

// get/set SPARE_OUT2 aliases
#define SPARE_OUT2_TRIS               TRISCbits.TRISC5
#define SPARE_OUT2_LAT                LATCbits.LATC5
#define SPARE_OUT2_PORT               PORTCbits.RC5
#define SPARE_OUT2_SetHigh()            do { LATCbits.LATC5 = 1; } while(0)
#define SPARE_OUT2_SetLow()             do { LATCbits.LATC5 = 0; } while(0)
#define SPARE_OUT2_Toggle()             do { LATCbits.LATC5 = ~LATCbits.LATC5; } while(0)
#define SPARE_OUT2_GetValue()           PORTCbits.RC5
#define SPARE_OUT2_SetDigitalInput()    do { TRISCbits.TRISC5 = 1; } while(0)
#define SPARE_OUT2_SetDigitalOutput()   do { TRISCbits.TRISC5 = 0; } while(0)
